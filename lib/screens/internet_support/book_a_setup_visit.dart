...
import 'package:community_app/controllers/internet_support/book_a_setup_visit.dart';
...
class BookASetupVisit extends StatefulWidget {
  const BookASetupVisit({super.key});

  @override
  State<BookASetupVisit> createState() => _BookASetupVisitState();
}

class _BookASetupVisitState extends State<BookASetupVisit> {
  final dropdown = TerritorialAreaClass();
  final controller = Get.put(BookASetupVisitController());
  @override
  void initState() {
    super.initState();
          ...
          child: Column(
            children: [
              ...
              MyAppBar(
                showMenuIcon: false,
                showBackIcon: true,
                screenName: 'Book a Setup Help Visit',
                showBottom: false,
                userName: false,
                      ...
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color:
                                  controller.contactedType.value == 3
                                      ? Colors.transparent
                                      : Colors.white,
                              borderRadius: BorderRadius.circular(6),
                              border: Border.all(
