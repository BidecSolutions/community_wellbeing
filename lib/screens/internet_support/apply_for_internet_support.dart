...
import 'package:community_app/controllers/internet_support/apply_for_internet_support_controller.dart';
...
class ApplyForInternetSupport extends StatefulWidget {
  const ApplyForInternetSupport({super.key});

  @override
  State<ApplyForInternetSupport> createState() =>
      _ApplyForInternetSupportState();
}

class _ApplyForInternetSupportState extends State<ApplyForInternetSupport> {
  final dropdown = TerritorialAreaClass();
  final controller = Get.put(ApplyForInternetSupportController());
  @override
  void initState() {
    super.initState();
          ...
          child: Column(
            children: [
              ...
              MyAppBar(
                showMenuIcon: true,
                showBackIcon: true,
                screenName: 'Apply For Internet Support',
                showBottom: false,
                userName: false,
              ...
              //                 items:
              //                     dropdown.requestTypes.map((index) {
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: controller.contactedType.value == 1 ? Colors.transparent : Colors.white,
                              borderRadius: BorderRadius.circular(6),
                              border: Border.all(
                                color: controller.contactedType.value == 1 ? Colors.black : Colors.transparent,
                                width: 1.5,
                              ),
                            ),
                            child: const Center(
                      ...
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: controller.contactedType.value == 2 ? Colors.transparent : Colors.white,
                              borderRadius: BorderRadius.circular(6),
                              border: Border.all(
                                color: controller.contactedType.value == 2 ? Colors.black : Colors.transparent,
                                width: 1.5,
                              ),
                            ),
                            child: const Center(
                      ...
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: controller.contactedType.value == 3 ? Colors.transparent : Colors.white,
                              borderRadius: BorderRadius.circular(6),
                              border: Border.all(
                                color: controller.contactedType.value == 3 ? Colors.black : Colors.transparent,
                                width: 1.5,
                              ),
                            ),
                            child: const Center(
