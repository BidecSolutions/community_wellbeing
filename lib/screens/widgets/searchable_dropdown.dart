...
class CustomSearchableDropdown extends StatefulWidget {
  final String apiUrl = "${AppSettings.baseUrl}housing/territorial-area";
  final ValueChanged<String>? onItemSelected;

  const CustomSearchableDropdown({super.key, this.onItemSelected});
