...
import '../../controllers/social_support/request_a_social_worker_controller.dart';
...
class RequestASocialWorker extends StatefulWidget {
  const RequestASocialWorker({super.key});

  @override
  State<RequestASocialWorker> createState() => _RequestASocialWorkerState();
}

class _RequestASocialWorkerState extends State<RequestASocialWorker> {
  ...
  final controller = Get.put(RequestASocialWorkerController());
          ...
          child: Column(
            children: [
              ...
              MyAppBar(
                showMenuIcon: true,
                showBackIcon: true,
                screenName: 'Request A Social Worker',
                showBottom: false,
                userName: false,
