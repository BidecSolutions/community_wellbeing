...
import '../../controllers/justice/rebuild_foam_controller.dart';
...
class _RebuildState extends State<Rebuild> {
  ...
  final controller = Get.put(RebuildFoamController());
          ...
          child: Column(
            children: [
              ...
              MyAppBar(
                showMenuIcon: true,
                showBackIcon: true,
                screenName: 'Get Support to Rebuild Your Life',
                showBottom: false,
                userName: false,
                      ...
                      child: OutlinedButton(
                        ...
                        onPressed: () {
                          showGetSearchableBottomSheet(
                            context: context,
                            api: 'justice/support-rebuild-category',
