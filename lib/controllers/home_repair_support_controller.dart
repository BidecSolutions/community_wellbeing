...
class HomeRepairSupportController extends GetxController {
  ...
  Future<bool> homeRepairingService() async {
    ...
    if (requestId.value == "") {
      message.value = "Please Select the Type of Issue";
      return false;
    }
    ...
    final url = Uri.parse('${AppSettings.baseUrl}housing/home-repair-service');
    ...
    request.fields['ownership_type'] =
        (selectedOwned.value == 'Owned'
                ? 1
                : selectedOwned.value == 'Rent'
                ? 2
                : 0)
            .toString();
    request.files.add(
